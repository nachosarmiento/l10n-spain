...
def _get_csv_path():
    ...
    candidates = [
        base_dir / "mod190_partner_subkeys_o16.csv",
        base_dir.parent / "18.0.1.3.0" / "mod190_partner_subkeys_o16.csv",
        base_dir.parent / "18.0.1.0.0" / "mod190_partner_subkeys_o16.csv",
    ]
...
def _migrate_partner_subkeys_from_csv(env):
    ...
    if not csv_path:
        _logger.warning("mod190 subkeys CSV not found in known migration paths")
        return
    ...
    _logger.info(
        "mod190 partner subkeys post-migration: csv=%s loaded=%s "
        "updated_by_id=%s updated_by_vat=%s",
        csv_path,
        loaded_rows,
        updated_by_id,
        updated_by_vat,
